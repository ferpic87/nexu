...
function elgg_views_add_rss_link() {
	...
	if (isset($autofeed) && $autofeed == true) {
		...
		elgg_register_menu_item('extras', array(
			'name' => 'rss',
			'text' => elgg_view_icon('rss').elgg_echo('feed:rss'),
			'href' => $url,
...
function elgg_views_boot() {
	...
	elgg_register_js('jquery', '/vendors/jquery/jquery-1.7.2.js', 'head');
	...
	elgg_load_js('jquery.elastic');
	elgg_load_js('jquery.events.input');
	elgg_load_js('jquery.mentionsInput');
	...
	elgg_register_simplecache_view('css/jquery.mentionsInput');
	$mentionsInput_css_url = elgg_get_simplecache_url('css', 'jquery.mentionsInput');
	elgg_register_css('jquery.mentionsInput', $mentionsInput_css_url);
	elgg_load_css('jquery.mentionsInput');
