...
.elgg-admin-notices p {
	...
	behavior: url("<?php echo elgg_get_site_url(); ?>pie/PIE.htc"); behavior: url("<?php echo elgg_get_site_url(); ?>pie/PIE.htc"); -moz-border-radius: 4px;
	border-radius: 4px;
}
...
.elgg-module-inline > .elgg-head {
	...
	behavior: url("<?php echo elgg_get_site_url(); ?>pie/PIE.htc"); behavior: url("<?php echo elgg_get_site_url(); ?>pie/PIE.htc"); -moz-border-radius: 3px;
	border-radius: 3px;
}
...
input {
	...
	behavior: url("<?php echo elgg_get_site_url(); ?>pie/PIE.htc"); behavior: url("<?php echo elgg_get_site_url(); ?>pie/PIE.htc"); -moz-border-radius: 5px;
	border-radius: 5px;
	margin: 0;
}
...
.friends-picker {
	...
	behavior: url("<?php echo elgg_get_site_url(); ?>pie/PIE.htc"); behavior: url("<?php echo elgg_get_site_url(); ?>pie/PIE.htc"); -moz-border-radius: 8px;
	border-radius: 8px;
}
