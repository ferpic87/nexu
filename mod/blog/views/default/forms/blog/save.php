...
$missing = addslashes(elgg_echo('blog:abstractMissing'));
$too_long = addslashes(elgg_echo('blog:abstractLong'));


$save_button = elgg_view('input/submit', array(
	'value' => elgg_echo('save'),
	'name' => 'save',
	'onclick' => "return checkAbstract('".$missing."','".$too_long."')"
));
...
preg_match('/group\/([0-9]+)\//', $referer, $matches);
preg_match('/group\/([0-9]+)\//', $thisURL, $matches2);
...
$charleft=elgg_echo('blog:charleft');
...
<div id="thewire-characters-remaining" style="margin-top:-15px"> <span>140 </span> $charleft </div>
