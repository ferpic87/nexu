...
?>
	...
	.comment_reduced_icon {
		background: transparent url(<?php echo $vars['url']?>mod/river_comments/graphics/river_icon_comment.png) no-repeat;
	}
	.river_comment_loading{
		background: transparent url(<?php echo $vars['url']?>mod/river_comments/graphics/loading.gif) no-repeat center right;
	}
