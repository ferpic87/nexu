...
$english = array(
	...
	'notifications:subscriptions:friends:title' => 'Following',
	'notifications:subscriptions:friends:description' => 'Below are collections of your following. Selecting a collection turns on notifications for the users in that collection.',
	...
	'notifications:subscriptions:title' => 'Notifications per favourite user',
	'notifications:subscriptions:description' => 'To receive notifications from your following (on an individual basis) when they create new content, find them below and select the notification method you would like to use.',
