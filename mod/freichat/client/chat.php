            ...
            <div data-role="content">
                <div class="frei_mobile_users" id="frei_mobile_rooms">
                    <div class="u_scroller">
                        <ul class="users_ul" id="rooms_ul" data-role="listview" data-inset="true" data-filter="true">
                            <?php echo $frei_trans["mobile_loading"]; ?>
                        </ul>
                    </div>
                </div>
                ...
                function fill_room_data() {
                    ...
                    for (var i = 0; i < len; i++) {
                        ...
                        wrapper += "<li id='frei_lobby_room_"+mobile.room_array[i].room_id+"' data-role='button' data-corners='false' class='rooms_li' \n\
                                    onclick=\"FreiChat.open_panel('" + mobile.room_array[i].room_name + "','" + mobile.room_array[i].room_id + "','chatroom', '" + data + "')\" class=\"freichat_userlist\" \n\
                                    ><div> \n\
        ...
        <div id="chatroom_users" data-role="page">
            ...
            <div data-role="content">
                <div class="frei_mobile_users" id="frei_mobile_rooms_users">
                    <div class="u_scroller">
                        <ul class="users_ul" id="rooms_users_ul" data-role="listview" data-inset="true" data-filter="true">
                            <?php echo $frei_trans["mobile_loading"]; ?>
                        </ul>
                    </div>
                </div>
