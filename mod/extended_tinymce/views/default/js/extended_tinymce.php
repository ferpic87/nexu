...
elgg.extended_tinymce.init = function() {
	...
	tinyMCE.init({
		...
		theme_advanced_buttons1 : "bold,italic,underline,strikethrough,|,justifyleft,justifycenter,justifyright,justifyfull,|, bullist,numlist,|,blockquote,link,unlink,|,forecolor,backcolor,|,image,emotions,charmap,|,code",
		...
		setup : function(ed) {
			...
			ed.onKeyPress.add(function(ed, e) {
				...
				var txt = String.fromCharCode(keyPress);
				if(txt == "@") {
					showSuggestions($(tinyMCE.activeEditor.selection.getNode()));
					prev = -1;
				}			
				prev = keyPress;
			});
