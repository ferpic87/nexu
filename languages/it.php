...
$language = array (
  ...
  'profile:field:tags' => 'Tags (separati da virgole)',
  ...
  'river:friend:user:default' => '%s ora segue %s',
  ...
  'river:widgets:friends' => 'Attività delle persone che segui',
  'river:widgets:all' => 'Attività dell\'intero sito',
  'thewire:hide' => 'Nascondi',
  ...
  'tag:search:startblurb' => 'Voci con tag trovate \'%s\':',
  'settings' => 'Impostazioni',
  'settings:edit' => 'Modifica impostazioni',
  'registerok' => 'Ti sei registrato correttamente su %s.',
  ...
  'registration:usernametooshort' => 'Il tuo username deve essere lungo un minimo di %u caratteri.',
  'registration:usernametoolong' => 'Il tuo username è troppo lungo. Può avere un massimo di %u caratteri.',
...
<dt>Sviluppa</dt><dd>Per gli sviluppatori che stanno costruendo plugin o disegnando temi. (Richiede il plugin di sviluppatore).</dd>         
  ...
  'river:friends' => 'Attività delle persone che segui',
  'river:select' => 'Mostra %s',
  'river:comments:more' => '+%u altro',
  'river:generic_comment' => 'commentato su %s',
  'friends:widget:description' => 'Mostra alcune tra le persone che segui.',
  'friends:num_display' => 'Numero di persone che segui da visualizzare',
  ...
  'mine' => 'Mio',
  'none' => 'nessuno',
  'tagcloud:allsitetags' => 'Tutte i tags del sito',
  'on' => 'On',
  'off' => 'Off',
  'edit:this' => 'Modifica',
...
Per rimuovere un Widget, riportalo indietro nella <b>Galleria-Widget</b>.',
  ...
  'friends:add:successful' => 'Hai aggiunto con successo %s tra le persone che segui.',
  'friends:add:failure' => 'Non possiamo aggiungere %s tra le persone che segui. Per favore riprova.',
  'friends:remove:successful' => 'Hai rimosso con successo %s tra le persone che segui.',
  'friends:remove:failure' => 'Non possiamo rimuovere %s dalle persone che segui. Per favore riprova.',
  'friends:none' => 'Questo utente non segue ancora nessuno .',
  'friends:none:you' => 'Non segui ancora nessuno! Cerca il tuo interesse per iniziare la ricerca delle persone da seguire.',
  'friends:none:found' => 'Nessun amico è stato trovato.',
  'friends:of:none' => 'Nessuno segue ancora questo utente.',
  'friends:of:none:you' => 'Non ti segue ancora nessuno. Inizia ad aggiungere un contenuto e a compilare il proprio profilo per permettere alle persone di trovarti!',
  'friends:of:owned' => 'Persone che seguono %s',
  'friends:of' => 'Amici di',
  'friends:collections' => 'Collezione di amici',
  'friends:collections:add' => 'Nuova collezione di amici',
  'friends:addfriends' => 'Aggiungi ai tuoi',
  ...
  'search:go' => 'Vai',
  'userpicker:only_friends' => 'Solo persone che seguo',
  'account' => 'Account',
  'tools' => 'Strumenti',
  'register' => 'Registrati',
...
',
  ...
  'friend:newfriend:subject' => '%s ti segue!',
  'friend:newfriend:body' => '%s ti segue
